                        ...
                        <div id="product-carousel" className="carousel slide" data-ride="carousel">
                            <div className="carousel-inner bg-light">
                                <div className="carousel-item active">
                                    <img className="w-100 h-100" src="img/product-1.jpg" alt="Image1" />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src="img/product-2.jpg" alt="Image2" />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src="img/product-3.jpg" alt="Image3" />
                                </div>
                                <div className="carousel-item">
                                    <img className="w-100 h-100" src="img/product-4.jpg" alt="Image4" />
                                </div>
                            </div>
                            <li className="carousel-control-prev" href="#product-carousel" data-slide="prev">
                                    ...
                                    <div className="row">
                                        <div className="col-md-6">
                                            ...
                                            <div className="media mb-4">
                                                <img src="img/user.jpg" alt="Image6" className="img-fluid mr-3 mt-1" style={{ width: '45px' }} />
